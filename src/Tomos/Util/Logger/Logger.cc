...
namespace Tomos
{
    ...
    Logger& Logger::log( LogLevel level )
    {
        ...
        if ( instance.currentLevel == LogLevel::DEBUG && instance.buildType == BuildType::RELEASE )
        {
            return instance;
        }
        ...
        std::cout << std::endl << instance.getTimestamp() << instance.getColorPrefix();
        return instance;
    }
